    ...
    return (
        <div className="min-h-screen py-12 px-4 bg-[#0a0f18]">
            <div className="max-w-3xl mx-auto">
                <Button variant="ghost" asChild className="mb-10 text-slate-400 hover:text-white transition-colors">
                    <Link href={`/blog/${username}`}>
                        <ArrowLeft className="mr-2 h-4 w-4" /> Back to {username}'s blog
                    </Link>
                </Button>
                ...
                <header className="mb-12">
                    <div className="flex items-center gap-3 mb-6 flex-wrap">
                        ...
                        <Badge variant="outline" className="ml-auto bg-white/5 border-white/10 text-slate-400">
                            <Sparkles size={14} className="text-violet-400 mr-2" />
